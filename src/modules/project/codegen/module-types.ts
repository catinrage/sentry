...
export namespace ProjectModule {
  interface DefinedFields {
    Project: 'id' | 'code' | 'title' | 'quantity' | 'fee' | 'dueDate' | 'createdAt' | 'updatedAt';
  ...
  interface DefinedEnumValues {
    ProjectStageStateEnum: 'PENDING' | 'IN_PROGRESS' | 'PAUSED' | 'COMPLETED';
  };
  
  interface DefinedInputFields {
    ProjectInputCreate: 'code' | 'title' | 'quantity' | 'fee' | 'dueDate';
    ProjectInputUpdate: 'code' | 'title' | 'quantity' | 'fee' | 'dueDate';
  };
  
  export type ProjectStageStateEnum = DefinedEnumValues['ProjectStageStateEnum'];
